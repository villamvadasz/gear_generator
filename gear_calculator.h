...
#define _GEAR_CALCULATOR_H_
	...
	extern void gear_profile_shifter_calculator(float m, float alpha, float z1, float z2, float x1, float x2, GearStructure *gear);
	extern void gear_print(GearStructure *gear);
